...
Hoare has given a set of three talks at Heidelberg Laurate Conferences where he talks about the coherence of logic, algebra, and geometry in Computer Science
